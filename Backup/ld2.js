...
function overwriteProxyGroups (params) {
    ...
    const autoProxyGroupRegexs = [
        ...
        { name: "SG - 自动选择", regex: / 新加坡 | 狮城 | SG| sg*| sg1| reality|Singapore|🇸🇬/ },
    ...
    const manualProxyGroups = [
        ...
        { name: "SG - 手工选择", regex: / 新加坡 | 狮城 | SG| sg*| sg1| reality|Singapore|🇸🇬/ , icon: "https://fastly.jsdelivr.net/gh/clash-verge-rev/clash-verge-rev.github.io@main/docs/assets/icons/flags/sg.svg" },
